Attribute VB_Name = "G17_ConvertUREGLoop_SUMMER_"
'ver20190821_by cjt

'转化SWITCH
Sub G17_ConvertUREGLoop_SUMMER()
...
'EQU_ID = Element_ID + 6   'EQUid号
CV_ID = Element_ID + 6     'OPid号
OPEU_ID = Element_ID + 7    'OPEUid号
...
X4_Tag = M6PN_TI
'M
HNPN_TI = UREGC_arr(UREGC_i, UREGC("M")) '赋值
Call F2_ConvertPN_TI(HNPN_TI) '转换
M_Tag = M6PN_TI
''B
...
Call BOX_XML(Blok_Tag, Blok_ID, Element_X, Element_Y, Sort_ID, "SUMMER_CTRL")
...
Call BoxIn_XML("M", M_Tag, M_ID, "true")
...
Call Input_XML(M_Tag, M_ID, Element_X - 2, Element_Y + 5)
