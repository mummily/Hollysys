...
Dim SELXINP_ID As Long         'EUQid号变量
...
Dim SELXINP_Tag As String         'EUQ位号变量
...
S1_ID = Element_ID + 5       'S1id号
S2_ID = Element_ID + 6       'S2id号
S3_ID = Element_ID + 7        'S3id号
S4_ID = Element_ID + 8        'S4id号
SELXINP_ID = Element_ID + 9   'SELXINPid号
CV_ID = Element_ID + 10       '块CVid号
OPEU_ID = Element_ID + 11      'OPid号
