Attribute VB_Name = "I18_ConvertUREGPVLoop_SUMMER_"
'转化MIDOF3
Sub I18_ConvertUREGPVLoop_SUMMER()
'局部变量
'*****************************************************
'通用
...
'03---------位号tag获取
'03-01--块位号赋值
Blok_Tag = UREGPV_arr(UREGPV_i, UREGPV("NAME")) & "_SUM"
...
End If
'N
N_Tag = UREGPV_arr(UREGPV_i, UREGPV("N"))
...
Call BOX_XML(Blok_Tag, Blok_ID, Element_X, Element_Y, Sort_ID, "SUMMER")
...
Call BoxIn_XML("N", N_Tag, N_ID, "true")
...
Call Input_XML(N_Tag, N_ID, Element_X - 2, Element_Y + 13)
